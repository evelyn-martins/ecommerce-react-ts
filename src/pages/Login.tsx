    ...
    <div className='mb-71.5'>
      ...
      <div className='flex flex-col mx-auto w-80'>
        <div className='flex gap-2 py-2 border border-black200 rounded-sm w-80 cursor-pointer mb-8 justify-center hover:bg-white100'>
            ...
            <p className='text-black500 font-medium text-sm'>Continue with Google</p>
        </div>
        ...
        <div className='flex flex-col w-80'>
            ...
            <input type='email' className='border border-black100 rounded-md py-2.5 px-2 mb-4'/>
            <label className='text-black600 font-medium text-sm'>Password</label>
            <input type='password' className='border border-black100 rounded-md py-2.5 px-2'/>
        </div>
        <div className='mt-4 mb-6 ml-auto'>
            <p className='text-black600 font-medium text-xs cursor-pointer hover:underline'>Forgot Password?</p>
        </div>
        <div className='w-80'>
            <Button children='Login' arrow={false}/>
        </div>
        <div className='mt-6 mx-auto'>
            <p className='text-black500 text-sm cursor-pointer hover:underline'>Don't have an account? Sign up</p>
        </div>
      </div>
    </div>
  )
